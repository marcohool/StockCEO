...
def get_previous_month_graph(symbol):
    ...
    r = requests.get(f'http://api.marketstack.com/v1/eod?access_key=74cd69d0a0103bfc1bcb7518d93023e3&symbols={symbol}&limit=30')
    closing_prices = []
    price_dates = []
    json = r.json()
    data = json['data']
